<script lang="ts">
        ...
        function clonerEquipement(equipement: Equipement): Equipement {
                return {
                        ...equipement,
                        prixParServeur: equipement.prixParServeur ? { ...equipement.prixParServeur } : {}
                };
        }
        ...
        function editer(equipement: Equipement) {
                ...
                enEdition = clonerEquipement(equipement);
        }
        ...
        async function importerCsv(event: Event) {
                ...
                resultatImport = `Import terminé : ${resume.ajoutes} nouveaux prix, ${resume.misAJour} mis à jour, ${resume.ignores} lignes ignorées.`;
